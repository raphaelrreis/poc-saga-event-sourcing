...
public class KafkaObjects {
	...
	@Bean
	KafkaTemplate<String, ConsumidorVerificadoEvent> consumidorVerificadoKafkaTemplate() {
	...
	@Bean
	DefaultKafkaProducerFactory<String, ConsumidorVerificadoEvent> producerFactory() {
	...
	// para poder fazer o distributed tracing
	@Bean
	ConsumerFactory<String, PedidoSolicitadoEvent> consumerFactory() {
	...
	public Map<String, Object> consumerConfigs() {
		...
		props.put(JsonDeserializer.TYPE_MAPPINGS, typeMappings(PedidoSolicitadoEvent.class));
